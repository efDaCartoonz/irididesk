...
{ /// Attached/detached.
  ...
  /// combination of subscription requests and draw events.
  SUBSCRIPTIONS_REQUESTS_AND_DRAW = 0x500,

        /// behavior event + method call + scripting method call.
        BEHAVIOR_METHOD_AND_SCRIPTING = 0x0700,
