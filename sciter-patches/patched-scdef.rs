...
pub enum SCITER_CREATE_WINDOW_FLAGS {
  ...
  SW_MAIN       = 1 << 7,
  /// main resizeable window.
  SW_MAIN_RESIZEABLE = (1 << 7) | (1 << 2),
  /// main resizeable window with controls.
  SW_MAIN_CONTROLS_RESIZEABLE = (1 << 7) | (1 << 4) | (1 << 2),
  /// main titled resizeable window with controls.
  SW_MAIN_TITLE_CONTROLS_RESIZEABLE = (1 << 7) | (1 << 4) | (1 << 2) | (1 << 1),
